...
class Graphics:
    def __init__(self,device_connected,window_size=(600,400)):
        ...
        pygame.init()
        self.window = pygame.display.set_mode((window_size[0]*1, window_size[1]))   ##twice 600x400 for haptic and VR
        ...
        # ORiginal ; self.effort_cursor  = pygame.Rect(*self.haptic.center, 0, 0).inflate(self.haptic_width, self.haptic_height) 
        
        ###################THIS LINE HAS BEEN EDITED#############################################
        self.effort_cursor  = pygame.Rect(*self.haptic.center, 0, 0).inflate(48, 48) #changed##########################
        ######################################################################################
