    ...
    def serial_ports(self):
        ...
        for p in ports:
            try:
                ...
                # if "Arduino Zero" in p.description or "VID:PID=2341:804D" in p.hwid:     #the device wasn't named on my computer.
                if "VID:PID=2341:804D" in p.hwid:
                    result.append(port)
                    print(f"Found device: {p.description} on {port}")
